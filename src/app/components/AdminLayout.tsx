...
const navItems: { path: string; label: string; icon: React.ComponentType<{ size?: number; className?: string }>; roles?: string[] }[] = [
  ...
  { path: "/admin/residents", label: "Residents Registry", icon: Users, roles: ["admin", "captain", "staff"] },
  { path: "/admin/requests", label: "Document Requests", icon: FileText },
  { path: "/admin/blotter", label: "Blotter Records", icon: Shield },
  { path: "/admin/officials", label: "Officials Management", icon: Award, roles: ["admin", "captain", "secretary"] },
  { path: "/admin/announcements", label: "Announcements", icon: Megaphone },
  { path: "/admin/polls", label: "Community Polls", icon: BarChart2, roles: ["admin", "captain", "secretary"] },
  { path: "/admin/reports", label: "Reports & Analytics", icon: TrendingUp },
  { path: "/admin/concerns", label: "Reported Concerns", icon: AlertTriangle, roles: ["admin", "captain", "secretary", "staff"] },
  { path: "/admin/suggestions", label: "Suggestions & Feedback", icon: MessageSquare, roles: ["admin", "captain", "secretary"] },
  { path: "/admin/contact-messages", label: "Contact Messages", icon: MailIcon, roles: ["admin", "captain", "secretary"] },
  { path: "/admin/volunteers", label: "Volunteer Registrations", icon: Heart, roles: ["admin", "captain", "secretary"] },
  ...
  { path: "/admin/business-registry", label: "Business Registry", icon: Store, roles: ["admin", "captain", "secretary"] },
  { path: "/admin/projects", label: "Projects", icon: Building2, roles: ["admin", "captain", "secretary"] },
  { path: "/admin/clearance-requests", label: "Clearance Requests", icon: FileCheck, roles: ["admin", "captain", "secretary", "staff"] },
